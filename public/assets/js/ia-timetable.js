...
async function _ttLoadStats() {
    try {
        const res = await fetch(APP_URL + '/api/admin/timetable?stats=1');
...
async function _ttLoadBatches() {
    ...
    try {
        // Load Courses
        const cRes = await fetch(APP_URL + '/api/admin/courses');
        ...
        const bRes = await fetch(APP_URL + '/api/admin/batches');
...
window.saveTimetableSlot = async function() {
    ...
    try {
        const res = await fetch(APP_URL+'/api/admin/timetable',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify(payload)});
        const data = await res.json();
...
window.deleteTimetableSlot = async function() {
    ...
    try {
        const res = await fetch(APP_URL+'/api/admin/timetable',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({action:'delete',id})});
        const data = await res.json();
